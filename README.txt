...
Object Oriented code with basic autoload on hook_boot(), namespaces and closures (require PHP 5.3+).


-- HOW TO USE SEARCH EXCLUDE --

  1. Download and enable this module. Choice the 7.x-1.0 or 7.x-
     2.0 version (explained above)
